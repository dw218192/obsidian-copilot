 ...
 * external sources get fetched into `.context-cache/`.
 */
 ...
 * — and therefore the `.context-cache/` location and resolved cwd — moves when
 * the file is renamed/relocated even if the config is byte-identical). Two

      ...
      <ScrollArea className="tw-min-h-0 tw-flex-1">
        <div className="tw-flex tw-flex-col tw-gap-6 tw-p-4">
          ...
          {/* Processing Status — the CAG variant reads the CAG cache; the agent
              variant reads the agent pipeline's own data (load atom +
              `.context-cache`). Retry/open-cache stay CAG-only: agent retry is a
              whole-run affair in the composer's context status popover. */}

...
export interface OpenSessionInput {
   ...
   * project's materialized context directories). Forwarded only at
   * session/new, and only by backends that report
...
export interface BackendProcess {
   ...
   * (widening the agent's searchable roots at session/new). Optional like the
